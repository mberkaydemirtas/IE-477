# -*- coding: utf-8 -*-
"""
Welding Shop Scheduling – 4 jobs, 80 ops
Makine tipleri + daha karmaşık precedence yapısı
"""
...
# ===============================
#  DATA – 4 jobs, 20 ops each (80 ops), 12 machines, 9 stations
# ===============================
...
model = Model("Welding_Full_LaTeX_Integrated_4jobs80ops")
...
# !!! i != h şartı burada sağlandı (LaTeX modeline uygun)
