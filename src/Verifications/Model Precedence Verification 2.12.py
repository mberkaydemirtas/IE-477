...
# EK ADIM: (İstersen kaldırabilirsin, ama şimdilik aynı bıraktık)
...
# ===============================
#  Due dates d_j (Sıkılaştırılmış – paralellik teşvik)
# ===============================

# Teorik ideal tam paralel çözümden gelen yaklaşık değerler:
# Job 1: C_final ≈ 11
# Job 2: C_final ≈ 16
d_j = {
    1: 11.0,
